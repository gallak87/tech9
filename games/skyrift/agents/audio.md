# Agent: audio
**Responsibility:** Define the audio direction for skyrift.
...
## Current Phase Goal
**Phase 6 — Audio Integration:** audio designs and implements all SFX via Web Audio API: shoot sounds (5 variants, one per weapon level), enemy hit, explosion (small for enemies, large for boss), weapon-level-up fanfare, boss phase transition sting, boss death. dev integrates audio events at the correct trigger points.

...
function boss(id, file, nativeSourceScale, shadow, rows) {
  return Object.freeze({
    ...
    rows: 2,
    nativeSourceScale,
    pixelScale: nativeSourceScale,
    facing: 'left',
    shadow,
    poseIndex,
    frames: rows.map(
      ([pose, x, y, right, bottom, groundX, groundY, exclude]) => ({
        pose,
        x,
        y,
        w: right - x,
...
export const MIRE_WARDEN_ART = boss(
  'mire_warden',
  'mire-warden-source.png',
  0.27,
  { radiusX: 35, radiusY: 7 },
  [
...
export const MAGMA_BEHEMOTH_ART = boss(
  'magma_behemoth',
  'magma-behemoth-source.png',
  0.34,
  { radiusX: 64, radiusY: 10 },
  [
...
export const ARCHITECT_HERALD_ART = boss(
  'architect_herald',
  'architect-herald-source.png',
  0.305,
  { radiusX: 31, radiusY: 6 },
  [
...
export const FROST_COLOSSUS_ART = boss(
  'frost_colossus',
  'frost-colossus-source.png',
  0.33,
  { radiusX: 59, radiusY: 10 },
  [
...
export const VOID_ARCHITECT_ART = boss(
  'void_architect',
  'void-architect-source.png',
  0.38,

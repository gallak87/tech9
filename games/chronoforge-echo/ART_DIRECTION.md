...
Community restoration follows Haventide’s summary panel and compact upgrade rows: project names, costs, unmet requirements, and inline Confirm/Cancel. Omit repeated descriptions and local-level captions. Keep balances visible above the world scrim. The completion reward names the weapon, owner, and power tier; its orange surface marks its community origin. Show a disabled unchecked box with “Complete [final project] to receive”; after the automatic award, check it and label it “Received,” with a direct inventory link. Present future reforging separately, with its cost or next hero-level requirement. The three community weapons keep a lava-orange outline and subtle orange surface tint in Inventory, Party, shops, reward notices, restoration panels, and their quest records. Use one power-band badge, never a second Exotic badge competing with it; one weapon illustration persists through all bands.
...
Item power bands share one palette across Inventory, equipped gear, vendors, quest rewards, and loot notices: Survivor white, Reclaimer green, Ascendant purple, Transcendent blue. Survivor surfaces use a 30%-opacity white tint; text stays fully opaque, with darker tier text on parchment. Only the three community keepsakes can reach a fifth power band, Exotic, through an explicit reforge at owner level 40+. Its badge is lava-orange; their permanent orange card treatment remains unchanged. Below tier 5 these weapons use the ordinary level badge without a second Exotic label. Civilization and ordinary equipment retain four bands.
...
The community weapons use three dedicated sources in `community-icon-manifest.js`: Duneglass Blade combines amber desert glass and copper; Rescue Gauntlets use pale metal and cobalt; Orchard Staff uses pale living branches, platinum, and plum crystal. All twelve power variants reuse these three sources with real alpha and measured crops.

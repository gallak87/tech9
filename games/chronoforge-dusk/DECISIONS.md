...
| Original assets establish recognizable identity | Agents may inspect `../chronoforge/src/assets/` directly for character designs, world motifs, and color identity. Character appearance follows its own references. Environments use grounded architecture, believable materials, and natural lighting. AAA quality is an ambition for execution and presentation. |
...
- **Presentation:** 3D characters and environments seen through an elevated, authored 2.5D camera. Character appearance follows the current character references, preserving costume, silhouette, and color identity. Environments use grounded forms, weathered materials, and natural lighting; composition and color balance bring them together on screen.

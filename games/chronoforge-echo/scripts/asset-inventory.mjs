...
- **${Object.keys(BUILDINGS).length} civic structures × four levels:** Town Center, Farm, Mine, Energy Extractor, Barracks, Forge, Research Lab and Walls, split across production/culture sheets. Shared settlement rules drive the visible level.
...
- **${Object.keys(ITEMS).length} item identities:** original 32×32 code-native icons in [src/item-art.js](../src/item-art.js), reused by inventory, shops and restrained queued reward badges.

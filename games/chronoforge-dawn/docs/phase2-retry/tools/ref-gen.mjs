...
//
//   node docs/phase2-retry/tools/ref-gen.mjs docs/phase2-retry/reference-manifest.json
//   node docs/phase2-retry/tools/ref-gen.mjs docs/phase2-retry/reference-manifest.json --only kaida
//

...
- Preserve original Chronoforge identity through polished new assets. Character appearance follows its character references; environments use grounded architecture, believable materials, and natural lighting. “AAA quality” describes the finish sought. Use original assets as design references within the current assignment; production-asset or code reuse still needs a specific allowance.

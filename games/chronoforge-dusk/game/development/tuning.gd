...
const DEFAULTS: Dictionary = {"walk_speed": 2.99, "run_speed": 6.63, "turn_speed": 18.0, "camera_yaw": 25.0, "camera_pitch": 34.0, "camera_distance": 9.6, "impact_fraction": 0.5, "light_game": true, "attack_tempo": 1.0, "hit_stop": 0.065, "walk_stride_speed": 5.01623, "run_stride_speed": 6.48387, "acceleration": 28.0, "braking": 36.0}

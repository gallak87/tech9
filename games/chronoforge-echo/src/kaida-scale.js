...
export const kaidaWalkScale=direction=>.23*BODY_HEIGHT/WALK_ROW_HEIGHTS[direction];
export const kaidaPoseScale=index=>.23*BODY_HEIGHT/(index===10?315:index===11?322:BODY_HEIGHT);

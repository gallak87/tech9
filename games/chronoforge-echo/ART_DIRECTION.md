...
Item rarities share one palette across Inventory, equipped gear, vendors, quest rewards, and loot notices: Survivor white, Reclaimer green, Ascendant purple, Transcendent blue, and the three community weapons Exotic orange. Survivor surfaces use a 30%-opacity white tint; text stays fully opaque, with darker tier text on parchment. Exotic rarity is immediate and permanent, independently of each weapon’s forge strength. Only those three weapons have the explicit level-40 reforge beyond ordinary gear’s power ceiling; that improvement retains their existing Exotic badge. Civilization and ordinary equipment retain four bands.

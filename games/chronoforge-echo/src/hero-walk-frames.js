...
export const HERO_WALK_ART = [
  {id:'vex',source:'assets/vex/faceless-vex-hood-v2-walk-source.png',columns:4,rows:3,sourceWidth:1447,sourceHeight:1087,pixelScale:.24,preserveSourceAlpha:true,frames:frames(
    [[34,5,334,343],[403,4,691,344],[760,4,1065,344],[1128,4,1401,344],
     [60,343,345,691],[439,343,684,691],[784,343,1061,691],[1158,343,1417,691],
     [85,691,379,1054],[451,691,712,1056],[805,691,1098,1050],[1168,691,1443,1053]],
    [[235,338],[580,338],[963,339],[1315,338],[204,685],[560,685],[928,685],[1296,685],[215,1046],[570,1048],[938,1042],[1298,1045]])
    ...
    .map((frame,i)=>({...frame,pixelScale:i<4?.24:i<8?.232:.226}))},

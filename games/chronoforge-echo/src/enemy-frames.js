...
function enemyAtlas(id, file, nativeSourceScale, shadow, rows, extra = {}) {
  return Object.freeze({
    ...
    frames: rows.map(
      ([pose, x, y, right, bottom, groundX, groundY, clearRects]) => ({
        pose,
        x,
        y,
        w: right - x,
...
export const MUTANT_HOUND_ART = enemyAtlas(
  'mutant_hound',
  'mutant-hound-source.png',
  0.23,
  { radiusX: 36, radiusY: 7 },
  [
...
export const GRAVBOT_ART = enemyAtlas(
  'gravbot',
  'gravbot/obsidian-gravbot-source.png',
  0.2,
  { radiusX: 28, radiusY: 6 },
  [
...
export const NEON_CULTIST_ART = enemyAtlas(
  'neon_cultist',
  'neon-cultist-source.png',
  0.185,
  { radiusX: 23, radiusY: 5 },
  [
...
export const SANDWORM_ART = enemyAtlas(
  'sandworm',
  'sandworm-source.png',
  0.22,
  { radiusX: 40, radiusY: 7 },
  [
...
export const BOG_STALKER_ART = enemyAtlas(
  'bog_stalker',
  'bog-stalker-source.png',
  0.205,
  { radiusX: 23, radiusY: 5 },
  [
...
export const SLAG_RAT_ART = enemyAtlas(
  'slag_rat',
  'slag-rat-source.png',
  0.195,
  { radiusX: 29, radiusY: 5 },
  [

...
| `shape` | do the levels have different cross-sections — RIDGE/FLAT/VALLEY at twelve points per level plus how far the floor moves. `--strict` fails when two levels share a shape set |

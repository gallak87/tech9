...
const source=read(readFileSync(new URL('../../assets/rune.png',here))),cell=181;
if(source.w!==cell*6||source.h!==cell*8)throw Error('Rune atlas dimensions changed; update guide landmarks first.');
...
const rest={head:[111,48],neck:[108,69],shoulderL:[77,81],shoulderR:[134,84],elbowL:[64,104],elbowR:[148,107],wristL:[63,127],wristR:[155,127],hipL:[91,122],hipR:[123,122],kneeL:[81,145],kneeR:[131,145],ankleL:[78,167],ankleR:[130,166],toeL:[85,176],toeR:[139,176]};
...
for(const [col,pose] of [rest,halfway,inhale].entries()){
 ...
 for(const name of Object.keys(pose))disc(...p(name),6,cyan);
 for(const name of ['toeL','toeR','hipL','hipR','wristL','wristR']){const [x,y]=p(name);line([x-12,y],[x+12,y],gold,3);line([x,y-12],[x,y+12],gold,3);}
}
